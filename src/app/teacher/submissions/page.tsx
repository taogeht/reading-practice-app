...
// Project-wide ease curve — applied to every interaction so the page
// reads with one consistent motion vocabulary.
...
export default function TeacherSubmissionsPage() {
  ...
  const classBuckets = Object.values(groupsByClass);

  return (
    <div className="min-h-[100dvh] bg-stone-50 text-stone-900">
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 pt-10 pb-24">
        {/* HEADER — sans page title, single subtitle line, text-link
            back navigation. No display fonts on UI labels. */}
        <header className="mb-10">
          <button
            type="button"
            onClick={() => router.push('/teacher/dashboard')}
            className="inline-flex items-center gap-1.5 text-[13px] text-stone-500 hover:text-stone-900 transition-colors duration-150 mb-6 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-600/40 focus-visible:ring-offset-2 rounded-sm"
          >
        ...
        {/* FILTER STRIP — true segmented control. Pill buttons inside a
            stone-bordered container, selected fills stone-900. Each
            button gets a custom-curve transition + active-state press
            feedback. */}
            ...
            {FILTERS.map(({ key, label, count }) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-baseline gap-1.5 px-3 py-1.5 text-[13px] rounded-[5px] transition-[background-color,color,transform] duration-200 active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-600/40 ${
                    active
                ...
                >
                  <span>{label}</span>
                  <span className="tabular-nums text-[12px] text-stone-400">
                    ({count})
                  </span>
                </button>
              );
        ...
        {classBuckets.length === 0 ? (
          ...
          <div className="space-y-12">
            {classBuckets.map(({ className, classId, groups }, classIdx) => {
              ...
              return (
                <section
                  key={classId}
                  // Class-group entrance stagger, capped at 240ms so a
                  // page with many classes doesn't accumulate a long
                  // tail of delays.
                  style={{
                    animation: `class-in 300ms ${EASE_OUT} both`,
                    animationDelay: `${Math.min(classIdx * 60, 240)}ms`,
                  }}
                >
                  {/* CLASS HEADER — no card. 1px top rule, sans heading,
                      meta line with counts and a "delete all" text
                      link. Whole row is the tap target; chevron uses
                      the project ease-out curve. */}
                  <div
                    role="button"
                    tabIndex={0}
                    ...
                    className="group cursor-pointer select-none border-t border-stone-300 pt-5 pb-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-600/40 focus-visible:ring-offset-2 rounded-sm transition-colors duration-150"
                    style={{ transitionTimingFunction: EASE_OUT }}
                                  ...
                                  >
                                    <div className="flex items-baseline justify-between gap-3 flex-wrap mb-3">
                                      ...
                                      <button
                                        ...
                                        className="text-stone-400 hover:text-rose-800 transition-colors duration-150 p-1 -m-1 active:scale-[0.92] transition-transform"
                                        style={{ transitionTimingFunction: EASE_OUT }}
                                        ...
                                        {feedbackMode === recording.id ? (
                                          <>
                                            <Button
                                              ...
                                              className="h-8 px-3 text-[13px] bg-stone-900 hover:bg-stone-800 text-stone-50 active:scale-[0.97] transition-[background-color,transform] duration-150"
                                              style={{ transitionTimingFunction: EASE_OUT }}
                                            >
                                            ...
                                            <Button
                                              ...
                                              className="h-8 px-3 text-[13px] text-stone-600 hover:bg-stone-100 active:scale-[0.97] transition-[background-color,transform] duration-150"
                                              style={{ transitionTimingFunction: EASE_OUT }}
                                            >
                                              Cancel
                                            </Button>
                                      ...
                                      <div className="mt-4 border-t border-stone-200 pt-4 space-y-4">
                                            ...
                                            {QUICK_RATINGS.map((rating) => {
                                              ...
                                              return (
                                                <button
                                                  ...
                                                  disabled={submittingFeedback}
                                                  className={`inline-flex items-center gap-1.5 px-2.5 py-1.5 border rounded-md text-[12px] transition-[background-color,border-color,color,transform] duration-200 active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-600/40 ${
                                                    isSelected
                                        ...
                                        <div>
                                          ...
                                          <Textarea
                                            ...
                                            rows={3}
                                            disabled={submittingFeedback}
                                            className="w-full border-stone-200 focus-visible:border-stone-900 focus-visible:ring-0 text-[14px] transition-colors duration-150"
                                            style={{ transitionTimingFunction: EASE_OUT }}
                                          />
                                        </div>
