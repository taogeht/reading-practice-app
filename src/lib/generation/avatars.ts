...
export const CHIBI_STYLE_PROMPT = `cute chibi cartoon style, full body character, neutral standing pose facing forward, arms slightly out, feet together, big expressive head, small simple body, bright vibrant colors, thick clean outlines, soft shading, flat simple background, transparent background, PNG format, no text, no watermarks, kid-friendly, Toca Boca inspired, high quality illustration`;
...
export const COSMETIC_STYLE_PROMPT = `cute chibi cartoon style, single isolated item, transparent background, no character, no person, item only, centered in frame, bright vibrant colors, thick clean outlines, soft shading, kid-friendly, Toca Boca inspired, high quality illustration, PNG format, no text, no watermarks, no background`;
