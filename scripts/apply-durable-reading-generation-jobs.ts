// Applies migrations/0059_durable_reading_generation_jobs.sql directly. The
...
const SQL_PATH = path.resolve(
  process.cwd(),
  'migrations/0059_durable_reading_generation_jobs.sql',
);
