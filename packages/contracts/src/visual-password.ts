...
export const VISUAL_PASSWORD_ANIMALS: VisualPasswordOption[] = [
...
export const VISUAL_PASSWORD_OBJECTS: VisualPasswordOption[] = [
...
export const STUDENT_AVATARS: VisualPasswordOption[] = [
...
export function visualPasswordOptions(
  type: 'animal' | 'object',
): readonly VisualPasswordOption[] {
  return type === 'animal' ? VISUAL_PASSWORD_ANIMALS : VISUAL_PASSWORD_OBJECTS;
}
